    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_type', models.CharField(choices=[('individual', 'Individual'), ('team', 'Equipe'), ('institutional', 'Institucional')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('owner', 'Dono'), ('admin', 'Administrador'), ('member', 'Membro'), ('guest', 'Convidado')], default='member', max_length=20)),
